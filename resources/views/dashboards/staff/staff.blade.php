                ...
                <div class="round-search position-relative">
                    <span class="search-icon position-absolute">
                        <svg width="18" height="18" viewBox="0 0 18 18">
                            <circle cx="8" cy="8" r="7" stroke="#bfc5ce" stroke-width="2" fill="none" />
                            <line x1="13" y1="13" x2="17" y2="17" stroke="#bfc5ce" stroke-width="2" />
                        </svg>
                    </span>
                        ...
                        <div class="staff-dashboard-calendar-col mt-4">
                            <div class="content-card calendar-offwhite staff-dashboard-calendar-card">
                                ...
                                <div class="calendar staff-dashboard-calendar">
                                    <div
                                        class="d-flex justify-content-between align-items-center mb-3 staff-dashboard-calendar-header">
                                        <span class="fw-bold" id="calendar-month-label">August 2025</span>
                                        <span
                                            class="calendar-nav-group d-flex align-items-center staff-dashboard-calendar-nav">
                                            <button id="calendar-up-btn"
                                                class="btn btn-sm btn-light ms-2 staff-dashboard-calendar-btn"><span
                                                    class="staff-dashboard-calendar-btn-icon">&#9650;</span></button>
                                            <button id="calendar-down-btn"
                                                class="btn btn-sm btn-light ms-1 staff-dashboard-calendar-btn"><span
                                                    class="staff-dashboard-calendar-btn-icon">&#9660;</span></button>
                                        </span>
                                    </div>
                        ...
                        <div class="d-flex w-100 align-items-center gap-2">
                            <div class="flex-grow-1">
                                <select class="form-select task-select" id="task-dropdown">
                                    ...
                                    @foreach ($tasks as $t)
                                        <option value="{{ $t['id'] }}">{{ $t['id'] }} – {{ $t['task'] }}
                                            ({{ $t['priority'] }})</option>
                                    @endforeach
                                </select>
                            </div>
                            <button type="button" class="btn btn-primary px-4" id="complete-task-btn"
                    ...
                    <div class="d-flex flex-row align-items-start mb-4 staff-shift-row">
                        ...
                        <div class="d-flex flex-column justify-content-start staff-shift-request-col">
                            <div class="content-card staff-shift-request-card">
                                ...
                                <button class="btn btn-primary w-100 staff-shift-request-btn" id="request-shift-btn"
                                    disabled>Request to Shift Change</button>
                            </div>
                        </div>
                    </div>
                </section>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="fulltime"
                                                    value="fulltime" checked>
                                                <label class="form-check-label" for="fulltime">Full Time</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="type" id="parttime"
                                                    value="parttime">
                    ...
                    <div class="modal-card">
                        ...
                        <div class="d-flex justify-content-center gap-3 mt-3">
                            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                @csrf
                                <button type="submit" class="btn btn-primary" id="confirm-logout">Confirm</button>
                            </form>
